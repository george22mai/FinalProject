...
public class MainActivityFragment1 extends Fragment {
    ...
    public void tellJoke() {
        new EndpointsAsyncTask1(getContext()).execute(new Pair<Context, String>(getContext(), "Nume"));
    }
}
...
class EndpointsAsyncTask1 extends AsyncTask<Pair<Context, String>, Void, String> {
    ...
    public EndpointsAsyncTask1(Context contextt){
        context = contextt;
    }
    ...
    protected void onPostExecute(String result) {
        Intent intent = new Intent(context, com.example.jokeactivity.MainActivity.class);
